...
from core.Campus.infra.campus_django_app.models import Company
from core.Campus.infra.campus_django_app.serializers import ContractCreateSerializer, EmployeeCreateSerializer
